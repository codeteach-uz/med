...
import com.dataprizma.model.Role;
...
public class BaseFormController implements ServletContextAware {
    ...
    protected boolean isAdmin(User user) {
        return hasRole(user, new Role(Constants.ADMIN_ROLE));
    }

    protected boolean isUserRole(User user) {
        return hasRole(user, new Role(Constants.USER_ROLE));
    }

    protected boolean hasRole(User user, Role role) {
